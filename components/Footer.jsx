  ...
  return (
    <footer className=" pt-12 xl:pt-24 bg-primary text-white text-center">
      <div className=" container mx-auto">
        <div className="flex flex-col gap-8">
          ...
          <form className="flex flex-col xl:flex-row w-full max-w-[720px] mx-auto gap-5">
            ...
            <button className="btn w-full xl:max-w-[150px] rounded-md h-[60px] btn-accent">
              Join
            </button>
          </form>
          <div className="flex gap-8 mx-auto text-[25px] text-white/60 mb-20">
            <Link href="">
              <RiYoutubeFill />
            </Link>
            <Link href="">
      ...
      <div className=" py-6 border-t border-white/5 text-white/60">
        Copyright &copy; 2024 Mobiles. All rights reserved.
      </div>
    </footer>
  );
};
